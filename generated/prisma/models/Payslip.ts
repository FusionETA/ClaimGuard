...
export type $PayslipPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  scalars: runtime.Types.Extensions.GetPayloadResult<{
    ...
    cp38: runtime.Decimal
    /**
     * Additional PCB (Employment Income) — a manual top-up the admin
     * enters that is added directly to the month's PCB. Unlike CP38 it
     * carries NO dedicated CP39 column: it is folded into the standard
     * PCB field of the CP39 text file (pcb-txt.ts adds pcb + voluntaryPcb).
     * Kept SEPARATE from `pcb` so next month's ytdPcb baseline excludes
     * it per LHDN MTD Spec 2026 page 14 X-definition ("shall NOT include
     * additional Monthly Tax Deduction requested by the employee").
     * Sourced from `deduct_additional_pcb` line items (addsToStandardPcb).
     * 0 when no such line item exists.
     */
    voluntaryPcb: runtime.Decimal
    hrdf: runtime.Decimal
    zakat: runtime.Decimal
