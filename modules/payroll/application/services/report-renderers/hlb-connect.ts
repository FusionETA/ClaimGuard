...
/**
 * Spreadsheet equivalent of the above. HLB's blank template shows the
 * dropdown label ("New IC No."), while a file generated by a working
 * integration used the compact `NEWIC`; we follow the generated file,
 * which is known to upload.
 */
...
/// Header row, in the CBIZ Bulk Payroll template's column order.
const CBIZ_HEADERS = [
  "Payment Mode",
...
export async function renderHlbConnectBizXlsx(input: {
  ...
  const sheetRows: (string | number)[][] = [
    ...
    ...rows.map((r) => [
      ...
      recipientReference,
      "",
      // ID validation is on whenever we actually hold an ID for them.
      r.idNumber ? "Y" : "",
