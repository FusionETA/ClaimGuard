      ...
      <Card>
        <CardHeader className="p-5 sm:p-6">
          ...
          <CardDescription className="text-sm leading-6">
            Account details used for routing approvals, payout notifications, and profile display.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-3 p-5 pt-0 sm:gap-4 sm:p-6 sm:pt-0 md:grid-cols-2">
          ...
          <div className="rounded-[20px] bg-surface-low p-4 sm:rounded-[24px] sm:p-5">
            <p className="text-[11px] uppercase tracking-[0.16em] text-muted-foreground sm:text-xs sm:tracking-[0.18em]">Project</p>
            <p className="mt-2 text-lg font-black sm:text-xl">{data.employee.project}</p>
          </div>
          <div className="rounded-[20px] bg-surface-low p-4 sm:rounded-[24px] sm:p-5">
            <p className="text-[11px] uppercase tracking-[0.16em] text-muted-foreground sm:text-xs sm:tracking-[0.18em]">Role</p>
