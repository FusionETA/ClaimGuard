...
export default async function SupervisorAttendanceDashboard() {
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Card className="rounded-2xl bg-secondary/60 p-4">
            ...
            <Link href="/supervisor/attendance/approvals">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link href="/supervisor/attendance/team">
            <div className="flex flex-col gap-2 rounded-2xl bg-primary p-4 text-primary-foreground shadow-panel transition-transform active:scale-95">
              <Users className="h-5 w-5" />
              <p className="text-sm font-bold">Team Directory</p>
            </div>
          </Link>
          <Link href="/employee/attendance">
            <div className="flex flex-col gap-2 rounded-2xl bg-secondary p-4 text-secondary-foreground shadow-panel transition-transform active:scale-95">
              <Users className="h-5 w-5" />
