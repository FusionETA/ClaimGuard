 ...
 * /api/v1/admin/organizations) — which is why this route does NOT live
 * under the `admin/` prefix. `/api/v1/admin/sso-ticket` is kept as a
 * backwards-compatible alias; see `app/api/v1/CLAUDE.md`.
 *
